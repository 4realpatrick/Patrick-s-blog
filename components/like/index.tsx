...
export default function Like() {
  ...
  return (
    <motion.button
      className="appearance-none border-none cursor-pointer bg-primary  text-background rounded-[36px] outline-none m-0 p-0 pl-[90px] text-4xl tracking-[-2px] font-semibold relative text-center flex items-center shadow-md main-btn"
      initial={false}
